<template>
  <div
    ...
    @contextmenu.prevent="elementContextmenu"
  >
    <div
  ...
  methods: {
    ...
    deselect (e) {
      ...
      if (!this.$el.contains(target) && !regex.test(target.className) 
          && (this.commonClassName && target.className.includes(this.commonClassName))
      ) {
